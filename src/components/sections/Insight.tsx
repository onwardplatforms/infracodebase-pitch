  ...
  return (
    <div className="flex flex-col h-full w-full px-4 md:px-12 lg:px-20 py-8 md:py-16">
      <motion.p
        ...
        className="text-muted-foreground text-xs md:text-sm uppercase tracking-wider mb-4 md:mb-8"
      >
        The insight
      </motion.p>
      ...
      <div className="flex-1 flex items-center justify-center px-2 md:px-0">
        <motion.h2
          ...
          className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold leading-tight text-foreground max-w-5xl text-center"
        >
